...
Este repositorio es un *fork* modificado del proyecto original [nRFBox](https://github.com/cifertech/nrfbox) creado por **cifertech**. Esta versión ha sido adaptada y expandida por el **HackNRF24Team** para enfocarse en la investigación y auditoría de protocolos de radiofrecuencia de baja frecuencia (Sub-GHz).
...
## 📜 Licencia y Créditos
El software base de este repositorio es propiedad de **cifertech** y se distribuye bajo la **Licencia MIT**. Las modificaciones y expansiones aquí presentadas mantienen la misma licencia abierta.
